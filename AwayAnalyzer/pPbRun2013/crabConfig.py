...
config.General.requestName = 'AwayAnalysisEtaAsso_1_2_0_Pt3_10'
...
config.JobType.outputFiles = ['pPb_Pbp_CombinedDiHadronCorrFunc_NoCutetaTrg_EtaAsso_1_2_0_Pt3_10.root']
